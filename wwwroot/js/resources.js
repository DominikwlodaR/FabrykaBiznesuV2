function showOptions(userInput, optionsListId, users, teamId, bnt) {
    ...
    const userList = users.map(u => u.TeamName);
    ...
    filteredOptions.forEach(option => {
        ...
        optionItem.addEventListener('click', () => {
            ...
            if (idInputElem) {
                const selectedUser = users.find(u => u.TeamName === option);
                idInputElem.value = selectedUser ? selectedUser.TeamId : '';
            }
        });
